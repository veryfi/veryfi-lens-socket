...
import UAParser from "./src/parser-wrapper.js";
...
const VeryfiLens = (function () {
  ...
  const parseUA = () => {
    ...
    return null; // Return null if not in browser environment or if UAParser is not available
  };
